...
<body class="container-fluid">
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		<a class="navbar-brand" href="#"> <!--<img src="/assets/brand/bootstrap-solid.svg" width="30" height="30" alt="">-->
			<h1>Logo</h1>
		</a>
	...
	<!-- formulaire-->
	<form id="needs-validation" class="col" novalidate action="">
		<div class="form-group row">
			<div class="col-sm-2"></div>
			<label for="formNom" class="col-sm-2 col-form-label">Nom</label>
			<div class="col-sm-6">
				<input type="text" class="form-control" id="formNom" name="nom"
		...
		<div class="form-group row">
			<div class="col-sm-2"></div>
			<label for="formDtn" class="col-sm-2 col-form-label">Date de
				naissance</label>
			<div class="col-sm-6">
				<input type="date" class="form-control" id="formDtn" name="ddn"
					placeholder="" required>
		...
		<div class="form-group row">
			...
			<div class="col-sm-6">
				<textarea class="form-control" id="formAddr" name="addr" rows="3"
					required cols=""></textarea>
				<div class="invalid-feedback">L'addresse est obligatoire.</div>
			</div>
		</div>

		<div class="form-group row">
			<div class="col-sm-2"></div>
			<label for="colFormLabel" class="col-sm-2 col-form-label">Numéro
				de sécurité sociale</label>
			<div class="col-sm-6">
				<input type="text" class="form-control" id="formNss" name="nss"
					placeholder="" required>
		...
		<div class="form-group row">
			...
			<div class="col-sm-8">
				<button type="button" class="btn btn-primary float-right"
					id="btnPopup" data-toggle="modal" data-target="#exampleModal">Créer</button>
			</div>
		</div>
	</form>
	<!-- Modal -->
